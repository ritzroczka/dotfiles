...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,xK_p), spawn "/home/ritzr0czka/Scripts/dmpd")
    , ((modShift,xK_p), spawn "/home/ritzr0czka/Scripts/dmpd --control")
    ...
    , ((modShift  , xK_m)      , spawn "urxvt -e mutt"        )
    , ((modShift  , xK_r)      , spawn "killall dzen2; xmonad --recompile; xmonad --restart")
    -- Alsa Multimedia Control
    , ((0, 0x1008ff11), spawn "/home/ritzr0czka/.xmonad/Scripts/volctl down"  )
    , ((0, 0x1008ff13), spawn "/home/ritzr0czka/.xmonad/Scripts/volctl up"    )
    , ((0, 0x1008ff12), spawn "/home/ritzr0czka/.xmonad/Scripts/volctl toggle")
    -- Brightness Control
    ...
    where modShift  = modm .|. shiftMask
          dmenuCall = "dmenu_run -b -nb '#050505' -nf '#ffffff' -sb '#050505' -sf '#ffffff' -p '>>' -fn '-jmk-dweep-medium-r-semicondensed-*-*-*-75-75-c-*-iso8859-1' -i"
...
myLogHook h = dynamicLogWithPP $ defaultPP
    ...
    where icon1 = "^i(/home/ritzr0czka/.xmonad/dzen/icons/stlarch/tile.xbm)^ca()"
          icon2 = "^i(/home/ritzr0czka/.xmonad/dzen/icons/stlarch/monocle.xbm)^ca()"
          icon3 = "^i(/home/ritzr0czka/.xmonad/dzen/icons/stlarch/bstack.xbm)^ca()"
          icon4 = "^i(/home/ritzr0czka/.xmonad/dzen/icons/stlarch/monocle2.xbm)^ca()"
...
main = do
    ...
    where callDzen1 = "dzen2 -ta l -fn '"
          ...
          callDzen2 = "sleep 1 && conky -c ~/.xmonad/conkyrc | dzen2 -x 0 -y 2 -ta c -fn '"
                     ++ dzenFont
